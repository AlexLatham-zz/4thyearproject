(function () {
    ...
    function u() {
        ...
        F = setTimeout(function () {
            ...
            if (a && a != r) {
                r = a;
                var l = p.parse(p.stringify(c.__jstorage_meta.CRC32)), k;
                C();
    ...
    var y = window.jQuery || window.$ || (window.$ = {}), p = {
    ...
    var c = {__jstorage_meta: {CRC32: {}}}, h = {jStorage: "{}"}, g = null, z = 0, f = !1, m = {}, F = !1, r = 0, t = {}, A = +new Date, G, B = {
        isXML: function (a) {
    ...
    (function () {
        ...
        } else if (g = document.createElement("link"),
                g.addBehavior) {
