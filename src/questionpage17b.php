...
<body onload = "createQuestionPage('17b')">
...
<div class = "container">
    ...
    <div class="row marketing">
        ...
        <div class="col-lg-6">
            ...
            <input type = 'image' src = '../img/previous.png' id = 'backPage' onclick = "location.href = 'questionpage17a.php'"/>
    ...
    <div class="progress">
        <div class="progress-bar" role="progressbar" aria-valuenow="70"
             aria-valuemin="0" aria-valuemax="100" style="width:70.4%">
