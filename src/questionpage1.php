...
<body onload = "createQuestionPage(1)">
...
<div class = "container">
    ...
    <div class="row marketing">
        <div class="col-lg-6">
            ...
            <img src = '../img/highbloodpressure.jpeg' id="pageimage">
        ...
        <div class="col-lg-6">
            ...
            <input type = 'image' src = '../img/previous.png' id = 'backPage' onclick = "location.href = 'patientwelcome.php'"/>
