...
<body onload = "createQuestionPage(7)">
...
<div class = "container">
    ...
    <div class="jumbotron" >
        <div class = 'hover_over'> <h2> Irregular heartbeat - An abnormal heart rhythm, means that your heart is beating too fast, too slow, or with an irregular pattern </h2></div>
        <div class = 'normal'>
    ...
    <div class="row marketing">
        <div class="col-lg-6">
            ...
            <img src = "../img/irregularheartbeatq7.jpg" id="pageimage" >
        ...
        <div class="col-lg-6">
            ...
            <input type = 'image' src = '../img/previous.png' id = 'backPage' onclick = "location.href = 'questionpage7.php'"/>
